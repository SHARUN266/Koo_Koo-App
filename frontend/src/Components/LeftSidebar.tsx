  ...
  return (
    <section className="fixed w-[275px] flex flex-col items-stretch h-screen  ">
          <div className=" flex flex-col items-stretch h-full space-y-4 mt-4 ">
            ...
            <button className="rounded-full m- bg-primary py-4  text-2xl text-center hover:bg-opacity-70  transition duration-2000000">
              Tweet
            </button>
          </div>
          <button className="rounded-full flex item-center space-x-2 m-4 p-4 hover:bg-white/10  transition duration-200  w-full justify-between">
